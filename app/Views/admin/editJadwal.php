            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="input-group">
                        ...
                        <input class="form-control" placeholder="Kode kelas" type="text" value="BIO01">
                    </div>
                    <br>
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        <input class="form-control" placeholder="Mata Pelajaran" type="text" value="Biologi">
                    </div>
                    <br>
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        <input class="form-control" placeholder="Nama Guru" type="text" value="Dadang Adi">
                    </div>
                    <br>
                    ...
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        <input class="form-control" placeholder="Jam Mulai" type="text" value="07.00">
                    </div>
                    <br>
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        <input class="form-control" placeholder="Jam Berakhir" type="text" value="08.30">
                    </div>
                    <br>
